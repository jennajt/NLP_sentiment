...
def fig_3(data_3):
    fig = px.line(emotion_count_df, x = 'Year', y=["Optimism", "Sadness", "Joy", "Anger"], title='Sentiment of Tweets Over Time',color_discrete_sequence=["yellow", "blue", "green", "red"])
...
# Positivity score by year, newspaper, likes
def fig_4(data_4):
    fig = px.scatter(filtered_df, x="Date", y="Positive",
